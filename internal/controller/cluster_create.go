...
func (r *ClusterReconciler) joinReplicaInstance(
	...
	if err := r.Create(ctx, pod); err != nil {
		...
		// A previous reconcile created the Pod but may not have finished
		// creating the PVCs. Fall through to CreateInstancePVCs so any
		// missing PVCs are created on this pass.
